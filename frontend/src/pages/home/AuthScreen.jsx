    ...
    return (
        <div className="hero-bg relative">
            ...
            <header className='max-w-6xl mx-auto flex justify-between items-center p-4 pb-10`'>
                ...
                <Link to="/login" className='text-white bg-red-600 py-1 px-2'> Login</Link>
            ...
            <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
                ...
                <p className='text-lg md:text-xl font-bold mb-4'>Watch anywhere . Cancel anytime</p>
                ...
                <form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleFormSubmit}>
                    ...
                    <button className='bg-red-600 text-lg lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center'>Get Started <ChevronRight className="size-8 md:size-10" /></button>
                </form>
            </div>
            ...
            <div className='py-10 bg-black text-white '>
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                    ...
                    <div className='flex-1 text-center md:text-left' >
                        ...
                        <p className='text-lg md:text-xl'>Watch on Smart TVss , Playstation , Xbox , Chromecast, Apple TV, Blu-ray players, and more</p>
                    </div>
                    <div className='flex-1 relative '>
                        <img src="/tv.png" alt="Tv" className='mt-4 z-20 relative' />
                        <video className='absolute top-1/2 left-1/2  -translate-x-1/2 -translate-y-1/2 h-1/2 z-10' playsInline autoPlay muted loop>
            ...
            <div className='py-10 bg-black text-white'>
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse  px-4 md:px-2'>
                    ...
                    <div className='flex-1 relative'>
                        <div className='relative'>
                            ...
                            <div className='flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2'>
                                <img src="/stranger-things-sm.png" alt="Strangerthings" className='h-full' />
                    ...
                    {/* right side */}
                    <div className='flex-1 md:left text-center '>
            ...
            <div className='py-10 bg-black text-white '>
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                    ...
                    <div className='flex-1 relative overflow-hidden '>
                        ...
                        <video className='absolute top-2 left-1/2  -translate-x-1/2 h-4/6 z-10 max-w-[63%]' playsInline autoPlay muted loop>
            ...
            <div className='py-10 bg-black text-white'>
                <div className='flex max-w-6xl mx-auto items-center flex-col-reverse md:flex-row px-4 md:px-2'>
                    ...
                    <p className='text-lg md:text-xl'>Send kids an avendure with their favorite characters in a space made just for them-free with your membership.</p>
                    </div>
                </div>
            </div>
